...
// Mock the image generation module (non-critical, always returns null in tests)
mock.module("@/features/chat/image-generation", () => ({
  generateHumorousImage: mock(() => Promise.resolve(null)),
}));
